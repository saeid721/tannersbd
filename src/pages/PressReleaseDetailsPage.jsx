// src/pages/PressReleaseDetailsPage.jsx
import React, { useEffect, useState } from 'react';
import { Container, Row, Col } from 'react-bootstrap';
import { Link, useParams, useNavigate } from 'react-router-dom';
import { motion } from 'framer-motion';
import styles from './PressReleaseDetailsPage.module.scss';
  ...
  if (!news) {
    return (
      <Container className={styles.notFound}>
        ...
        <Link to="/pressRelease" className={styles.backLink}>Back to Press Release</Link>
      </Container>
    );
  }
    ...
    <div className={styles.newsDetailsPage}>
      ...
      <section className={styles.hero}>
        ...
        <Container>
          ...
          >
            <Link to="/pressRelease" className={styles.backButton}>
              ...
              >
                ...
                <div className={styles.sidebarBox}>
                  ...
                  <div className={styles.categories}>
                    {['ওয়ার্কশপ', 'Visit', 'Training', 'Meeting', 'Event'].map((cat) => (
                      <Link key={cat} to="/pressRelease" className={styles.categoryLink}>
                        {cat}
                      </Link>
                    ))}
                  </div>
