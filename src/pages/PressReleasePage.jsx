// src/pages/PressReleasePage.jsx
import React, { useState, useRef } from 'react';
import { Container } from 'react-bootstrap';
import { Link } from 'react-router-dom';
import { motion, useInView, AnimatePresence } from 'framer-motion';
import styles from './PressReleasePage.module.scss';
      ...
      >
        ...
        <Container className={styles.heroContent}>
          ...
          <motion.p 
            ...
            variants={heroItemVariants}
          >
            Official Notices, Regulatory Updates, and Sector Guidelines for BTA Members
          </motion.p>
        </Container>
      </motion.div>
            ...
            <div className={styles.noticeList}>
              ...
              {pinnedNotice && (
                <motion.div 
                  ...
                  whileHover={{ x: 5 }}
                >
                  <Link to={`/pressRelease/${pinnedNotice.id}`} className={styles.noticeLink}>
              ...
              {serialNotices.map((notice, idx) => (
                <motion.div 
                  ...
                  whileHover={{ x: 5 }}
                >
                  <Link to={`/pressRelease/${notice.id}`} className={styles.noticeLink}>
                    <div className={styles.noticeBody}>
                      <div className={styles.noticeTags}>
                        {notice.tags.map((tag) => (
                          <motion.span 
