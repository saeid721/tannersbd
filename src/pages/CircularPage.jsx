            ...
            <div className={styles.noticeList}>
              ...
              {pinnedNotice && (
                <motion.div 
                  ...
                  whileHover={{ x: 5 }}
                >
                  <Link to={`/circular/${pinnedNotice.id}`} className={styles.noticeLink}>
              ...
              {serialNotices.map((notice, idx) => (
                <motion.div 
                  ...
                  whileHover={{ x: 5 }}
                >
                  <Link to={`/circular/${notice.id}`} className={styles.noticeLink}>
                    <div className={styles.noticeBody}>
                      <div className={styles.noticeTags}>
                        {notice.tags.map((tag) => (
                          <motion.span 
